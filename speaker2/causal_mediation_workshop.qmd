...
format:
  html:
    ...
    toc: true
resources:
  - "Workshop_ST_clean.pdf"
---

<div style="text-align: center;">
  <iframe src="Workshop_ST_clean_v2.pdf" width="100%" height="500px">
    <p>Your browser does not support PDFs. <a href="Workshop_ST_clean.pdf">Download the PDF</a>.</p>
  </iframe>
  <p style="font-size: 0.9em; margin-top: 10px;">
    <i>Having trouble viewing? <a href="Workshop_ST_clean.pdf" target="_blank">Click here to open or download the PDF directly.</a></i>
  </p>
</div>
